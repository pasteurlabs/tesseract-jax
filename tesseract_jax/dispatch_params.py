...
class DispatchParams:
    ...
    Attributes:
        ...
        live_output_paths: When set by the DCE rule, restrict a
            ``jacobian_vector_product`` call to the output tangents that survive
            dead-code elimination. ``None`` requests every differentiable output
            (the un-pruned default).
    """
